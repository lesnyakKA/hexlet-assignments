...
class AppTest {
    ...
    void testReversedSequence() {
        ReversedSequence reversed = new ReversedSequence("qwerty");
    ...
    void testReversedSequenceCharAt() {
        ReversedSequence charAt = new ReversedSequence("qwerty");
        char result = charAt.charAt(3);
        char expected = 'r';
        assertThat(result).isEqualTo(expected);
    }
    ...
    void testReversedSequenceLength() {
        ReversedSequence length = new ReversedSequence("qwerty");
    ...
    void testReversedSequenceSubSequence() {
        ReversedSequence sub = new ReversedSequence("qwerty");
        String result = sub.subSequence(3, 5).toString();
        String expected = "rt";
        assertThat(result).isEqualTo(expected);
    }
}
